...
interface GoalDao {
    ...
    @Query("SELECT * FROM goals WHERE yearMonth = :yearMonth AND periodType = :periodType ORDER BY id DESC")
    fun getGoalsByMonthAndPeriod(yearMonth: String, periodType: String): Flow<List<Goal>>
